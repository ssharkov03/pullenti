...
from PullentiPython.ner.NumberSpellingType import NumberSpellingType
...
from PullentiPython.ner.geo.internal.OrgItemToken import OrgItemToken
from PullentiPython.ner.MorphCollection import MorphCollection
from PullentiPython.ner.address.internal.PullentiNerAddressInternalResourceHelper import PullentiNerAddressInternalResourceHelper
from PullentiPython.ner.Referent import Referent
from PullentiPython.ner.core.Termin import Termin
from PullentiPython.ner.geo.internal.TerrTermin import TerrTermin
from PullentiPython.ner.core.TerminCollection import TerminCollection
from PullentiPython.ner.geo.internal.MiscLocationHelper import MiscLocationHelper
from PullentiPython.ner.core.IntOntologyItem import IntOntologyItem
from PullentiPython.ner.NumberToken import NumberToken
from PullentiPython.ner.core.MiscHelper import MiscHelper
from PullentiPython.ner.geo.internal.GeoAnalyzerData import GeoAnalyzerData
from PullentiPython.ner.geo.internal.GeoTokenData import GeoTokenData
from PullentiPython.ner.TextToken import TextToken
from PullentiPython.ner.geo.GeoReferent import GeoReferent
from PullentiPython.ner.address.internal.AddressItemToken import AddressItemToken
from PullentiPython.ner.geo.internal.CityItemToken import CityItemToken
...
class TerrItemToken(MetaToken):
    ...
    def initialize() -> None:
        ...
        t = TerrTermin._new1173("РЕСПУБЛИКА", MorphGender.FEMINIE)
        t.add_abridge("РЕСП.")
        ...
        TerrItemToken._m_terr_ontology.add(TerrTermin._new1174("РЕСПУБЛІКА", MorphLang.UA, MorphGender.FEMINIE))
        t = TerrTermin._new1175("ГОСУДАРСТВО", True, MorphGender.NEUTER)
        t.add_abridge("ГОС-ВО")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1176("ДЕРЖАВА", MorphLang.UA, True, MorphGender.FEMINIE)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1173("АВТОНОМНАЯ СОВЕТСКАЯ СОЦИАЛИСТИЧЕСКАЯ РЕСПУБЛИКА", MorphGender.FEMINIE)
        t.acronym = "АССР"
        TerrItemToken._m_terr_ontology.add(t)
        for s in ["СОЮЗ", "СОДРУЖЕСТВО", "ФЕДЕРАЦИЯ", "КОНФЕДЕРАЦИЯ"]: 
            TerrItemToken._m_terr_ontology.add(TerrTermin._new1178(s, True, True))
        for s in ["СОЮЗ", "СПІВДРУЖНІСТЬ", "ФЕДЕРАЦІЯ", "КОНФЕДЕРАЦІЯ"]: 
            TerrItemToken._m_terr_ontology.add(TerrTermin._new1179(s, MorphLang.UA, True, True))
        ...
        t = TerrTermin._new1184("ОБЛАСТЬ", True, MorphGender.FEMINIE)
        t.add_abridge("ОБЛ.")
        TerrItemToken._m_terr_noun_adjectives.add(Termin._new264("ОБЛАСТНОЙ", t))
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1186("REGION", True)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1187("ОБЛАСТЬ", MorphLang.UA, True, MorphGender.FEMINIE)
        t.add_abridge("ОБЛ.")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1188(None, True, "АО")
        t.add_variant("АОБЛ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1189(None, MorphLang.UA, True, "АО")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1184("РАЙОН", True, MorphGender.MASCULINE)
        t.add_abridge("Р-Н")
        t.add_abridge("Р-ОН")
        t.add_abridge("РН.")
        TerrItemToken._m_terr_noun_adjectives.add(Termin._new264("РАЙОННЫЙ", t))
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1187("РАЙОН", MorphLang.UA, True, MorphGender.MASCULINE)
        t.add_abridge("Р-Н")
        t.add_abridge("Р-ОН")
        t.add_abridge("РН.")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1184("УЛУС", True, MorphGender.MASCULINE)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1184("УЕЗД", True, MorphGender.MASCULINE)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1195("ГУБЕРНАТОРСТВО", True, True, MorphGender.NEUTER)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1195("ШТАТ", True, True, MorphGender.MASCULINE)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1186("STATE", True)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1198("ШТАТ", MorphLang.UA, True, True, MorphGender.MASCULINE)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1195("ПРОВИНЦИЯ", True, True, MorphGender.FEMINIE)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1198("ПРОВІНЦІЯ", MorphLang.UA, True, True, MorphGender.FEMINIE)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1186("PROVINCE", True)
        t.add_variant("PROVINCIAL", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1202("ПРЕФЕКТУРА", True, MorphGender.FEMINIE, True)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1203("PREFECTURE", True, True)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1195("ГРАФСТВО", True, True, MorphGender.NEUTER)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1184("АВТОНОМИЯ", True, MorphGender.FEMINIE)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1186("AUTONOMY", True)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1187("АВТОНОМІЯ", MorphLang.UA, True, MorphGender.FEMINIE)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1208("ЗАКРЫТОЕ АДМИНИСТРАТИВНО ТЕРРИТОРИАЛЬНОЕ ОБРАЗОВАНИЕ", True, MorphGender.NEUTER, "ЗАТО")
        TerrItemToken._m_terr_ontology.add(t)
        for s in ["РЕСПУБЛИКА", "КРАЙ", "ОКРУГ", "ФЕДЕРАЛЬНЫЙ ОКРУГ", "АВТОНОМНЫЙ ОКРУГ", "АВТОНОМНАЯ ОБЛАСТЬ", "НАЦИОНАЛЬНЫЙ ОКРУГ", "ВОЛОСТЬ", "ФЕДЕРАЛЬНАЯ ЗЕМЛЯ", "ВОЕВОДСТВО", "МУНИЦИПАЛЬНЫЙ РАЙОН", "МУНИЦИПАЛЬНЫЙ ОКРУГ", "АДМИНИСТРАТИВНЫЙ ОКРУГ", "ГОРОДСКОЙ РАЙОН", "ВНУТРИГОРОДСКОЙ РАЙОН", "АДМИНИСТРАТИВНЫЙ РАЙОН", "СУДЕБНЫЙ РАЙОН", "ВНУТРИГОРОДСКОЕ МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ", "СЕЛЬСКОЕ МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ", "ВНУТРИГОРОДСКАЯ ТЕРРИТОРИЯ", "МЕЖСЕЛЕННАЯ ТЕРРИТОРИЯ", "REPUBLIC", "COUNTY", "BOROUGH", "PARISH", "MUNICIPALITY", "CENSUS AREA", "AUTONOMOUS REGION", "ADMINISTRATIVE REGION", "SPECIAL ADMINISTRATIVE REGION"]: 
            ...
            if (s == "КРАЙ"): 
                t.add_abridge("КР.")
                TerrItemToken._m_terr_noun_adjectives.add(Termin._new264("КРАЕВОЙ", t))
                ...
                TerrItemToken._m_terr_noun_adjectives.add(Termin._new264("ОКРУЖНОЙ", t))
                t.add_abridge("ОКР.")
        ...
        for s in ["РЕСПУБЛІКА", "КРАЙ", "ОКРУГ", "ФЕДЕРАЛЬНИЙ ОКРУГ", "АВТОНОМНИЙ ОКРУГ", "АВТОНОМНА ОБЛАСТЬ", "НАЦІОНАЛЬНИЙ ОКРУГ", "ВОЛОСТЬ", "ФЕДЕРАЛЬНА ЗЕМЛЯ", "МУНІЦИПАЛЬНИЙ РАЙОН", "МУНІЦИПАЛЬНИЙ ОКРУГ", "АДМІНІСТРАТИВНИЙ ОКРУГ", "МІСЬКИЙ РАЙОН", "ВНУТРИГОРОДСКОЕ МУНІЦИПАЛЬНЕ УТВОРЕННЯ"]: 
            ...
            if (LanguageHelper.ends_with(s, "РАЙОН")): 
                ...
                t.gender = MorphGender.MASCULINE
            TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1184("ГОРОДСКОЙ ОКРУГ", True, MorphGender.MASCULINE)
        t.add_abridge("ГОР. ОКРУГ")
        t.add_abridge("Г.О.")
        t.add_abridge("Г/ОКРУГ")
        t.add_abridge("Г/О")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1184("СЕЛЬСКИЙ ОКРУГ", True, MorphGender.MASCULINE)
        t.add_abridge("С.О.")
        t.add_abridge("C.O.")
        ...
        t.add_abridge("С/О")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1187("СІЛЬСЬКИЙ ОКРУГ", MorphLang.UA, True, MorphGender.MASCULINE)
        t.add_abridge("С.О.")
        t.add_abridge("C.O.")
        t.add_abridge("С/ОКРУГ")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1216("СЕЛЬСКИЙ СОВЕТ", "СЕЛЬСКИЙ ОКРУГ", True, MorphGender.MASCULINE)
        ...
        t.add_abridge("С.АДМ.")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1186("ПОСЕЛКОВЫЙ ОКРУГ", True)
        t.add_variant("ПОСЕЛКОВАЯ АДМИНИСТРАЦИЯ", False)
        t.add_abridge("П.А.")
        t.add_abridge("П.АДМ.")
        t.add_abridge("П/А")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1216("ПОСЕЛКОВЫЙ СОВЕТ", "ПОСЕЛКОВЫЙ ОКРУГ", True, MorphGender.MASCULINE)
        t.add_abridge("П.С.")
        TerrItemToken._m_terr_ontology.add(t)
        TerrItemToken._m_terr_ontology.add(TerrTermin._new1219("АВТОНОМНЫЙ", True, True))
        TerrItemToken._m_terr_ontology.add(TerrTermin._new1220("АВТОНОМНИЙ", MorphLang.UA, True, True))
        TerrItemToken._m_terr_ontology.add(TerrTermin._new1221("МУНИЦИПАЛЬНОЕ СОБРАНИЕ", True, True, True))
        TerrItemToken._m_terr_ontology.add(TerrTermin._new1222("МУНІЦИПАЛЬНЕ ЗБОРИ", MorphLang.UA, True, True, True))
        t = TerrTermin._new1223("МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ", "МО", MorphGender.NEUTER)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1224("МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ МУНИЦИПАЛЬНЫЙ РАЙОН", "МОМР", True)
        t.add_variant("МО МР", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1225("МУНИЦИПАЛЬНЫЙ ОКРУГ ГОРОДСКОЙ ОКРУГ", "МУНИЦИПАЛЬНЫЙ ОКРУГ", "МОГО", True)
        t.add_variant("МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ ГОРОДСКОЙ ОКРУГ", False)
        t.add_variant("МО ГО", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("ЦЕНТРАЛЬНЫЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("ЦАО")
        t.add_variant("ЦЕНТРАЛЬНЫЙ АО", False)
        t.add_variant("ЦЕНТРАЛЬНЫЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("СЕВЕРНЫЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("САО")
        t.add_variant("СЕВЕРНЫЙ АО", False)
        t.add_variant("СЕВЕРНЫЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("СЕВЕРО-ВОСТОЧНЫЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("СВАО")
        t.add_variant("СЕВЕРО-ВОСТОЧНЫЙ АО", False)
        t.add_variant("СЕВЕРО-ВОСТОЧНЫЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("ВОСТОЧНЫЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("ВАО")
        t.add_variant("ВОСТОЧНЫЙ АО", False)
        t.add_variant("ВОСТОЧНЫЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("ЮГО-ВОСТОЧНЫЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("ЮВАО")
        t.add_variant("ЮГО-ВОСТОЧНЫЙ АО", False)
        t.add_variant("ЮГО-ВОСТОЧНЫЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("ЮЖНЫЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("ЮАО")
        t.add_variant("ЮЖНЫЙ АО", False)
        t.add_variant("ЮЖНЫЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("ЗАПАДНЫЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("ЗАО")
        t.add_variant("ЗАПАДНЫЙ АО", False)
        t.add_variant("ЗАПАДНЫЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("СЕВЕРО-ЗАПАДНЫЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("СЗАО")
        t.add_variant("СЕВЕРО-ЗАПАДНЫЙ АО", False)
        t.add_variant("СЕВЕРО-ЗАПАДНЫЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("ЗЕЛЕНОГРАДСКИЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("ЗЕЛАО")
        t.add_variant("ЗЕЛЕНОГРАДСКИЙ АО", False)
        t.add_variant("ЗЕЛЕНОГРАДСКИЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("ТРОИЦКИЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("ТАО")
        t.add_variant("ТРОИЦКИЙ АО", False)
        t.add_variant("ТРОИЦКИЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("НОВОМОСКОВСКИЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("НАО")
        t.add_variant("НОВОМОСКОВСКИЙ АО", False)
        t.add_variant("НОВОМОСКОВСКИЙ ОКРУГ", False)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1226("ТРОИЦКИЙ И НОВОМОСКОВСКИЙ АДМИНИСТРАТИВНЫЙ ОКРУГ", True)
        t.add_abridge("ТИНАО")
        t.add_abridge("НИТАО")
            ...
            for x in xml0_.getroot(): 
                ...
                if (Utils.getXmlName(x) == "state"): 
                    ...
                    if (a is not None and a[1] is not None): 
                        TerrItemToken._m_unknown_regions.add(Termin._new1238(a[1], lang))
    ...
    def __load_state(xml0_ : xml.etree.ElementTree.Element, lang : 'MorphLang') -> None:
        ...
        for x in xml0_: 
            if (Utils.getXmlName(x) == "n"): 
                ...
                c.termins.append(Termin._new1239(Utils.getXmlInnerText(x), lang))
                state._add_name(Utils.getXmlInnerText(x))
                if (acrs is None): 
                    acrs = list()
        ...
        if (a2 is not None): 
            ...
            a3 = None
            wrapa31240 = RefOutArgWrapper(None)
            inoutres1241 = Utils.tryGetValue(MiscLocationHelper._m_alpha2_3, a2, wrapa31240)
            a3 = wrapa31240.value
            if (inoutres1241): 
    ...
    def __load_region(xml0_ : xml.etree.ElementTree.Element, lang : 'MorphLang') -> None:
        ...
        for x in xml0_: 
            if (Utils.getXmlName(x) == "n"): 
                ...
                if (aterm is None): 
                    aterm = Termin._new572(reg.get_string_value(GeoReferent.ATTR_NAME), lang, reg)
                ...
                if (((term == "РБ" or term == "РК" or term == "TC") or term == "ТС" or term == "РТ") or term == "УР" or term == "РД"): 
                    ...
                    for it in ad.local_ontology.items: 
                        if (isinstance(it.referent, GeoReferent)): 
                            ...
                            if (((alph2 == "BY" and term == "РБ")) or ((alph2 == "KZ" and term == "РК"))): 
                                return TerrItemToken._new1243(t, t, it)
                            if (term == "РТ"): 
                    ...
                    if (ok): 
                        if (term == "РК" and TerrItemToken.__m_kazahstan is not None): 
                            return TerrItemToken._new1243(t, t, TerrItemToken.__m_kazahstan)
                        if (term == "РТ" and TerrItemToken.__m_tatarstan is not None): 
                            return TerrItemToken._new1243(t, t, TerrItemToken.__m_tatarstan)
                        if (term == "РД" and TerrItemToken.__m_dagestan is not None): 
                            return TerrItemToken._new1243(t, t, TerrItemToken.__m_dagestan)
                        if (term == "УР" and TerrItemToken.__m_udmurtia is not None): 
                            return TerrItemToken._new1243(t, t, TerrItemToken.__m_udmurtia)
                        if (term == "РБ" and TerrItemToken.__m_belorussia is not None and ad.step > 0): 
                            return TerrItemToken._new1243(t, t, TerrItemToken.__m_belorussia)
                        if (((term == "ТС" or term == "TC")) and TerrItemToken.__m_tamog_sous is not None): 
                            return TerrItemToken._new1243(t, t, TerrItemToken.__m_tamog_sous)
            if (((isinstance(t, TextToken)) and ((t.is_value("Р", None) or t.is_value("P", None))) and t.next0_ is not None) and t.next0_.is_char('.') and not t.next0_.is_newline_after): 
                ...
                if (res is not None and res.onto_item is not None): 
                    ...
                    if ("РЕСПУБЛИКА" in str0_): 
                        ...
                        res.is_doubt = False
                        return res
            return TerrItemToken.__try_parse_district_name(t, 0)
    ...
    def __try_parse(t : 'Token', prev : 'TerrItemToken', ignore_onto : bool=False) -> 'TerrItemToken':
        ...
        if (li is not None): 
            ...
            for nt in li: 
                if (nt.item is not None and not (isinstance(nt.termin.tag, IntOntologyItem))): 
                    if (not MiscHelper.is_all_characters_lower(nt.begin_token, nt.end_token, False) or nt.begin_token != nt.end_token): 
                        res0 = TerrItemToken._new1253(nt.begin_token, nt.end_token, nt.item, nt.morph)
            ...
            for nt in li: 
                if (nt.item is not None and (isinstance(nt.termin.tag, IntOntologyItem))): 
                    if (nt.end_token.next0_ is None or not nt.end_token.next0_.is_hiphen): 
                        res1 = TerrItemToken._new1254(nt.begin_token, nt.end_token, nt.item, True, nt.morph)
            ...
            for nt in li: 
                if (nt.termin is not None and nt.item is None): 
                    if (nt.end_token.next0_ is None or not nt.end_token.next0_.is_hiphen or not nt.termin.is_adjective): 
                        res1 = TerrItemToken._new1255(nt.begin_token, nt.end_token, Utils.asObjectOrNull(nt.termin, TerrTermin), nt.termin.is_adjective, nt.morph)
                        if (not res1.is_adjective): 
                            if (res1.termin_item.canonic_text == "РАЙОН"): 
                                if (t.previous is not None): 
                                    if (t.previous.is_value("МИКРО", None)): 
                                        return None
                                    if (t.previous.is_char_of("\\/.") and t.previous.previous is not None and t.previous.previous.is_value("М", None)): 
                                        return None
            ...
            if (tt.term in TerrItemToken._m_alpha2state): 
                ...
                if (isinstance(tt2, ReferentToken)): 
                    ...
                    if (r is not None and r.type_name == "PHONE"): 
                        ok = True
                if (ok): 
                    return TerrItemToken._new1243(tt, tt, TerrItemToken._m_alpha2state[tt.term])
        if (tt.length_char < 3): 
            return None
        ...
        if (npt is not None): 
            if (((npt.noun.is_value("ФЕДЕРАЦИЯ", None) or npt.noun.is_value("ФЕДЕРАЦІЯ", None))) and len(npt.adjectives) == 1): 
                if (MiscHelper.is_not_more_than_one_error("РОССИЙСКАЯ", npt.adjectives[0]) or MiscHelper.is_not_more_than_one_error("РОСІЙСЬКА", npt.adjectives[0])): 
                    return TerrItemToken._new1253(npt.begin_token, npt.end_token, (TerrItemToken.__m_russiaua if t0.kit.base_language.is_ua else TerrItemToken.__m_russiaru), npt.morph)
        ...
        if (not t0.chars.is_all_lower): 
            ...
            if (tok2 is not None): 
                return TerrItemToken._new1258(t0, tok2.end_token, True)
    ...
    @staticmethod
    def __try_parse_district_name(t : 'Token', lev : int=0) -> 'TerrItemToken':
        if (lev > 2): 
            return None
        ...
        str0_ = t.term
        res = TerrItemToken._new1259(t, t, True)
        ...
        if (dir0_ is not None): 
            ...
            if (res.end_token.whitespaces_after_count < 2): 
                res2 = TerrItemToken.__try_parse_district_name(res.end_token.next0_, lev + 1)
                ...
                if (t.chars.is_capital_upper and len(li) == 1 and ((li[0].is_city_region or ((li[0].termin_item is not None and li[0].termin_item.is_specific_prefix))))): 
                    ...
                    if (ci is not None and ci.end_token.next0_ is not None and ci.end_token.next0_.is_char(')')): 
                        ...
                        if (ci0.onto_item is not None and ci.onto_item == ci0.onto_item): 
                            ...
                            ci1 = TerrItemToken._new1260(t, ci.end_token.next0_, ci.onto_item, ci.termin_item)
                            li.append(ci1)
                            t = ci1.end_token
                        continue
    ...
    @staticmethod
    def _new1243(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'IntOntologyItem') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.onto_item = _arg3
        return res
    
    @staticmethod
    def _new1253(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'IntOntologyItem', _arg4 : 'MorphCollection') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.onto_item = _arg3
        res.morph = _arg4
        return res
    ...
    @staticmethod
    def _new1254(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'IntOntologyItem', _arg4 : bool, _arg5 : 'MorphCollection') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.onto_item = _arg3
    ...
    @staticmethod
    def _new1255(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'TerrTermin', _arg4 : bool, _arg5 : 'MorphCollection') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
    ...
    @staticmethod
    def _new1258(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.is_district_name = _arg3
        return res
    
    @staticmethod
    def _new1259(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.is_doubt = _arg3
        return res
    
    @staticmethod
    def _new1260(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'IntOntologyItem', _arg4 : 'TerrTermin') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.onto_item = _arg3
