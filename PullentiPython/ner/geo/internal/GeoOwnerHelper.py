                ...
                if ("город;" in hit or "місто" in hit or "city" in hit): 
                    if ("поселение" in lot): 
                        ...
                        if (not "городско" in lot): 
                            ...
                            return False
                    if ((((("поселок" in lot or "селище" in lot or "хутор" in lot) or "станица" in lot or "село" in lot) or "деревня" in lot or "городок" in lot) or "местечко" in lot or "аул" in lot) or "пункт" in lot): 
                        return True
                if ("поселение" in hit or "поселок" in hit): 
                    if ("деревня" in lot and "коттеджный поселок" in hit): 
                        return False
                    if (((("село;" in lot or "деревня" in lot or "хутор" in lot) or "аул" in lot or "пункт" in lot) or "станица" in lot or "починок" in lot) or "заимка" in lot or "местечко" in lot): 
                        return True
                    if (lot == "поселение;"): 
                        ...
                        if (hit != lot): 
                            return True
                    if (lot == "поселок;" and lo.get_slot_value(GeoReferent.ATTR_REF) is not None and hi.get_slot_value(GeoReferent.ATTR_REF) is None): 
                        if (rhi is not None and rlo is not None): 
                            return rhi.begin_char < rlo.end_char
                if ("деревня" in hit): 
                    if ("населенный пункт" in lot or "коттеджный поселок" in lot or "хутор" in lot): 
                        return True
