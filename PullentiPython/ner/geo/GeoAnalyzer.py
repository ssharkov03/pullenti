...
from PullentiPython.unisharp.Misc import Stopwatch
...
from PullentiPython.ner.address.internal.MetaAddress import MetaAddress
from PullentiPython.ner.address.internal.MetaStreet import MetaStreet
...
from PullentiPython.ner.geo.internal.MetaGeo import MetaGeo
...
from PullentiPython.ner.core.AnalyzerDataWithOntology import AnalyzerDataWithOntology
...
class GeoAnalyzer(Analyzer):
    ...
    def process(self, kit : 'AnalysisKit') -> None:
        ...
        from PullentiPython.ner.geo.internal.OrgTypToken import OrgTypToken
        from PullentiPython.ner.geo.internal.TerrDefineHelper import TerrDefineHelper
    ...
    def initialize() -> None:
        ...
        from PullentiPython.ner.geo.internal.TerrItemToken import TerrItemToken
        from PullentiPython.ner.geo.internal.CityItemToken import CityItemToken
        from PullentiPython.ner.address.AddressAnalyzer import AddressAnalyzer
