...
class DateRangeReferent(Referent):
    ...
    def calculate_date_range(self, now : datetime.datetime, from0_ : datetime.datetime, to : datetime.datetime, tense : int=0) -> bool:
        ...
        inoutres1011 = DateRelHelper.calculate_date_range2(self, now, from0_, to, tense)
        return inoutres1011
    ...
    @staticmethod
    def _new935(_arg1 : 'DateReferent', _arg2 : 'DateReferent') -> 'DateRangeReferent':
    ...
    @staticmethod
    def _new941(_arg1 : 'DateReferent') -> 'DateRangeReferent':
        res = DateRangeReferent()
        res.date_to = _arg1
        return res
    
    @staticmethod
    def _new942(_arg1 : 'DateReferent') -> 'DateRangeReferent':
        res = DateRangeReferent()
        res.date_from = _arg1
        return res