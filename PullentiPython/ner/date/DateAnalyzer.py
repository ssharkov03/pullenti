...
from PullentiPython.ner.date.internal.MetaDateRange import MetaDateRange
from PullentiPython.ner.MetaToken import MetaToken
from PullentiPython.ner.date.internal.MetaDate import MetaDate
...
from PullentiPython.ner.date.internal.DateAnalyzerData import DateAnalyzerData
...
class DateAnalyzer(Analyzer):
    ...
    def process(self, kit : 'AnalysisKit') -> None:
        ...
        from PullentiPython.ner.date.internal.DateExToken import DateExToken
        from PullentiPython.ner.date.internal.DateRelHelper import DateRelHelper
    ...
    def initialize() -> None:
        from PullentiPython.ner.date.internal.DateItemToken import DateItemToken
        from PullentiPython.ner.measure.MeasureAnalyzer import MeasureAnalyzer
