...
class NumberToken(MetaToken):
    ...
    def value(self, value_) -> str:
        ...
        n = 0
        wrapn2611 = RefOutArgWrapper(0)
        inoutres2612 = Utils.tryParseInt(self.__m_value, wrapn2611)
        n = wrapn2611.value
        if (inoutres2612): 
            self.__m_int_val = n
        else: 
    ...
    @staticmethod
    def _new688(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'NumberSpellingType', _arg5 : 'MorphCollection') -> 'NumberToken':
