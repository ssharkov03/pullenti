...
from PullentiPython.ner.business.FundsKind import FundsKind
...
class FundsItemToken(MetaToken):
    ...
    def try_parse(t : 'Token', prev : 'FundsItemToken'=None) -> 'FundsItemToken':
        ...
        while True:
            ...
            if (isinstance(re, OrganizationReferent)): 
                return FundsItemToken._new523(t, tt, FundsItemTyp.ORG, re)
            if (isinstance(re, MoneyReferent)): 
                ...
                if ((tt.next0_ is not None and tt.next0_.is_value("ЗА", None) and tt.next0_.next0_ is not None) and ((tt.next0_.next0_.is_value("АКЦИЯ", None) or tt.next0_.next0_.is_value("АКЦІЯ", None)))): 
                    typ0 = FundsItemTyp.PRICE
                res = FundsItemToken._new523(t, tt, typ0, re)
                return res
            if (re is not None): 
                break
            ...
            if (npt is not None): 
                ...
                if (npt.noun.is_value("АКЦІЯ", None) or npt.noun.is_value("АКЦИЯ", None)): 
                    res = FundsItemToken._new525(t, npt.end_token, FundsItemTyp.NOUN, FundsKind.STOCK)
                    ...
                    res = FundsItemToken._new526(t, npt.end_token, FundsItemTyp.NOUN, FundsKind.STOCK, "ценные бумаги")
                    ...
                    res = FundsItemToken._new525(t, npt.end_token, FundsItemTyp.NOUN, FundsKind.CAPITAL)
                if (res is not None): 
                ...
                if (val is not None): 
                    ...
                    if (not ok): 
                        ...
                        while ttt is not None: 
                            ...
                            ttt = ttt.next0_
                    if (ok): 
                        res = FundsItemToken._new528(t, tt, FundsKind.STOCK, FundsItemTyp.NOUN)
            ...
            if (isinstance(tt, NumberToken)): 
                ...
                if (num is not None): 
                    ...
                    if (num.ex_typ == NumberExType.PERCENT): 
                        res = FundsItemToken._new529(t, num.end_token, FundsItemTyp.PERCENT, num)
                ...
                if (t1.next0_ is not None and t1.next0_.is_value("ШТУКА", None)): 
                    t1 = t1.next0_
                return FundsItemToken._new529(t, t1, FundsItemTyp.COUNT, Utils.asObjectOrNull(tt, NumberToken))
            break
        return None
    ...
    @staticmethod
    def _new523(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsItemTyp', _arg4 : 'Referent') -> 'FundsItemToken':
    ...
    @staticmethod
    def _new525(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsItemTyp', _arg4 : 'FundsKind') -> 'FundsItemToken':
        res = FundsItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.kind = _arg4
        return res
    ...
    @staticmethod
    def _new526(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsItemTyp', _arg4 : 'FundsKind', _arg5 : str) -> 'FundsItemToken':
        res = FundsItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.kind = _arg4
    ...
    @staticmethod
    def _new528(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsKind', _arg4 : 'FundsItemTyp') -> 'FundsItemToken':
        res = FundsItemToken(_arg1, _arg2)
        res.kind = _arg3
        res.typ = _arg4
        return res
    ...
    @staticmethod
    def _new529(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsItemTyp', _arg4 : 'NumberToken') -> 'FundsItemToken':
        res = FundsItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.num_val = _arg4
        return res
