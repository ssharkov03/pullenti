...
from PullentiPython.ner.business.internal.FundsItemTyp import FundsItemTyp
from PullentiPython.ner.org.OrganizationAnalyzer import OrganizationAnalyzer
from PullentiPython.ner.money.MoneyReferent import MoneyReferent
from PullentiPython.ner.date.DateReferent import DateReferent
from PullentiPython.ner.Token import Token
from PullentiPython.ner.business.FundsReferent import FundsReferent
from PullentiPython.ner.business.internal.MetaBusinessFact import MetaBusinessFact
from PullentiPython.ner.Analyzer import Analyzer
from PullentiPython.ner.business.internal.FundsMeta import FundsMeta
from PullentiPython.ner.core.internal.PullentiNerCoreInternalResourceHelper import PullentiNerCoreInternalResourceHelper
from PullentiPython.ner.business.BusinessFactReferent import BusinessFactReferent
...
from PullentiPython.ner.business.internal.FundsItemToken import FundsItemToken
from PullentiPython.ner.business.internal.BusinessFactItem import BusinessFactItem
...
class BusinessAnalyzer(Analyzer):
    ...
    def images(self) -> typing.List[tuple]:
        res = dict()
        res[MetaBusinessFact.IMAGE_ID] = PullentiNerCoreInternalResourceHelper.get_bytes("businessfact.png")
        res[FundsMeta.IMAGE_ID] = PullentiNerCoreInternalResourceHelper.get_bytes("creditcards.png")
        return res
    ...
    def __analize_get(self, bfi : 'BusinessFactItem') -> 'ReferentToken':
        ...
        if ((isinstance(t1.get_referent(), FundsReferent)) and not (isinstance(bef.referent, FundsReferent))): 
            ...
            bfr = BusinessFactReferent._new531(bfi.base_kind)
    ...
    def __analize_get2(self, t : 'Token') -> 'ReferentToken':
        ...
        if (master is not None and slave is not None): 
            bfr = BusinessFactReferent._new531(BusinessFactKind.HAVE)
            bfr.who = master
    ...
    def __analize_agreement(self, bfi : 'BusinessFactItem') -> 'ReferentToken':
        ...
        if (first is None or second is None): 
            return None
        bf = BusinessFactReferent._new531(bfi.base_kind)
        bf.who = first
    ...
    def __analize_likelihoods(self, rt : 'ReferentToken') -> typing.List['ReferentToken']:
        ...
        i = 0
        while i < len(whos): 
            bfr = BusinessFactReferent._new542(bfr0.kind, bfr0.typ)
