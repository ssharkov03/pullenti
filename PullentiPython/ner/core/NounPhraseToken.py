...
class NounPhraseToken(MetaToken):
    ...
    def get_multivars(self) -> typing.List['NounPhraseMultivarToken']:
        ...
        while i < len(self.adjectives): 
            v = NounPhraseMultivarToken._new682(self.adjectives[i].begin_token, self.adjectives[i].end_token, self, i, i)
    ...
    def get_morph_variant(self, cas : 'MorphCase', plural : bool) -> str:
        ...
        """
        mi = MorphBaseInfo._new683(cas, MorphLang.RU)
        if (plural): 
    ...
    @staticmethod
    def _new650(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PrepositionToken') -> 'NounPhraseToken':
