...
from PullentiPython.ner.address.AddressBuildingType import AddressBuildingType
from PullentiPython.ner.address.AddressHouseType import AddressHouseType
