...
class SourceOfAnalysis:
    ...
    @staticmethod
    def _new93(_arg1 : str, _arg2 : typing.List[tuple], _arg3 : bool, _arg4 : str) -> 'SourceOfAnalysis':
    ...
    @staticmethod
    def _new118(_arg1 : str, _arg2 : str) -> 'SourceOfAnalysis':
        res = SourceOfAnalysis(_arg1)
        res.user_params = _arg2
        return res
    
    @staticmethod
    def _new678(_arg1 : str, _arg2 : bool) -> 'SourceOfAnalysis':
        res = SourceOfAnalysis(_arg1)
