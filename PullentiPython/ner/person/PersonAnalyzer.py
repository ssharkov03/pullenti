...
from PullentiPython.ner.person.internal.MetaPersonProperty import MetaPersonProperty
from PullentiPython.ner.person.internal.MetaPerson import MetaPerson
from PullentiPython.ner.TextToken import TextToken
from PullentiPython.ner.person.internal.MetaPersonIdentity import MetaPersonIdentity
...
class PersonAnalyzer(Analyzer):
    ...
    def create_analyzer_data(self) -> 'AnalyzerData':
        from PullentiPython.ner.person.internal.PersonAnalyzerData import PersonAnalyzerData
    ...
    def process(self, kit : 'AnalysisKit') -> None:
        ...
        from PullentiPython.ner.person.internal.PersonIdToken import PersonIdToken
        from PullentiPython.ner.person.internal.PersonAnalyzerData import PersonAnalyzerData
    ...
    def initialize() -> None:
        from PullentiPython.ner.person.internal.PersonAttrToken import PersonAttrToken
        from PullentiPython.ner.person.internal.PersonPropAnalyzer import PersonPropAnalyzer
        from PullentiPython.ner.person.internal.PersonIdToken import PersonIdToken
        from PullentiPython.ner.person.internal.PersonItemToken import PersonItemToken
