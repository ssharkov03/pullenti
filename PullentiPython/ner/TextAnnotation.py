...
class TextAnnotation:
    ...
    @staticmethod
    def _new658(_arg1 : 'SourceOfAnalysis', _arg2 : int, _arg3 : int) -> 'TextAnnotation':
        res = TextAnnotation()
        res.sofa = _arg1
    ...
    @staticmethod
    def _new934(_arg1 : 'SourceOfAnalysis', _arg2 : int, _arg3 : int, _arg4 : 'Referent') -> 'TextAnnotation':
        res = TextAnnotation()
        res.sofa = _arg1
        res.begin_char = _arg2
        res.end_char = _arg3
    ...
    @staticmethod
    def _new1286(_arg1 : int, _arg2 : int, _arg3 : 'Referent', _arg4 : 'SourceOfAnalysis') -> 'TextAnnotation':
        res = TextAnnotation()
    ...
    @staticmethod
    def _new2629(_arg1 : int, _arg2 : int, _arg3 : 'SourceOfAnalysis') -> 'TextAnnotation':
        res = TextAnnotation()
        res.begin_char = _arg1
        res.end_char = _arg2
        res.sofa = _arg3
    ...
    @staticmethod
    def _new2631(_arg1 : 'SourceOfAnalysis', _arg2 : 'Referent') -> 'TextAnnotation':
        res = TextAnnotation()
        res.sofa = _arg1
