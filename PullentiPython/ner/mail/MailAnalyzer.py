...
from PullentiPython.ner.mail.internal.MetaLetter import MetaLetter
from PullentiPython.ner.Referent import Referent
from PullentiPython.ner.mail.MailKind import MailKind
from PullentiPython.ner.mail.MailReferent import MailReferent
        ...
        while True:
            ...
            if (lines[0].typ == MailLine.Types.FROM): 
                ...
                while i < len(lines): 
                    if (lines[i].typ == MailLine.Types.FROM): 
                        ...
                        break
                    i += 1
                mail_ = MailReferent._new1297(MailKind.HEAD)
            ...
            while ii < len(lines): 
                if (lines[ii].typ == MailLine.Types.HELLO): 
                    mail_ = MailReferent._new1297(MailKind.HELLO)
            ...
            if (i0 < len(lines)): 
                if (t2 is not None and t2.previous is None): 
                    ...
                    mail_ = MailReferent._new1297(MailKind.BODY)
                    ...
                    if (mt.length_char > 0): 
                        ...
                        mail_.add_occurence_of_ref_tok(mt)
                if (t2 is not None): 
                    mail_ = MailReferent._new1297(MailKind.TAIL)
