...
class TextToken(Token):
    ...
    def check_value(self, dict0_ : typing.List[tuple]) -> object:
        ...
        if (dict0_ is None): 
            return None
        res = None
        wrapres2638 = RefOutArgWrapper(None)
        inoutres2639 = Utils.tryGetValue(dict0_, self.term, wrapres2638)
        res = wrapres2638.value
        if (inoutres2639): 
            return res
            ...
            for it in self.morph.items: 
                ...
                if (mf is not None): 
                    if (mf.normal_case is not None): 
                        wrapres2634 = RefOutArgWrapper(None)
                        inoutres2635 = Utils.tryGetValue(dict0_, mf.normal_case, wrapres2634)
                        res = wrapres2634.value
                        if (inoutres2635): 
                            return res
                    if (mf.normal_full is not None and mf.normal_case != mf.normal_full): 
                        wrapres2636 = RefOutArgWrapper(None)
                        inoutres2637 = Utils.tryGetValue(dict0_, mf.normal_full, wrapres2636)
                        res = wrapres2636.value
                        if (inoutres2637): 
                            return res
        return None
    ...
    def get_normal_case_text(self, mc : 'MorphClass'=None, num : 'MorphNumber'=MorphNumber.UNDEFINED, gender : 'MorphGender'=MorphGender.UNDEFINED, keep_chars : bool=False) -> str:
        ...
        if (num == MorphNumber.SINGULAR and mc is not None): 
            bi = MorphBaseInfo._new676(MorphClass._new212(mc.value), gender, MorphNumber.SINGULAR, self.morph.language)
    ...
    @staticmethod
    def _new654(_arg1 : 'MorphToken', _arg2 : 'AnalysisKit', _arg3 : int, _arg4 : int, _arg5 : str) -> 'TextToken':
        res = TextToken(_arg1, _arg2, _arg3, _arg4)
        res.term0 = _arg5
        return res
    
    @staticmethod
    def _new657(_arg1 : 'MorphToken', _arg2 : 'AnalysisKit', _arg3 : int, _arg4 : int, _arg5 : 'CharsInfo', _arg6 : str) -> 'TextToken':
        res = TextToken(_arg1, _arg2, _arg3, _arg4)
        res.chars = _arg5
        res.term0 = _arg6
        return res