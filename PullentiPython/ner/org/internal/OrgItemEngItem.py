...
class OrgItemEngItem(MetaToken):
    ...
    def initialize() -> None:
        ...
        t = Termin._new1113("Public Limited Company".upper(), "PLC")
        t.add_abridge("P.L.C.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Limited Liability Company".upper(), "LLC")
        t.add_abridge("L.L.C.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Limited Liability Partnership".upper(), "LLP")
        t.add_abridge("L.L.P.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Limited Liability Limited Partnership".upper(), "LLLP")
        t.add_abridge("L.L.L.P.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Limited Duration Company".upper(), "LDC")
        t.add_abridge("L.D.C.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("International Business Company".upper(), "IBC")
        t.add_abridge("I.B.S.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Joint stock company".upper(), "JSC")
        t.add_abridge("J.S.C.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Open Joint stock company".upper(), "OJSC")
        t.add_abridge("O.J.S.C.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Sosiedad Anonima".upper(), "SA")
        t.add_variant("Sociedad Anonima".upper(), False)
        t.add_abridge("S.A.")
        t.add_variant("SPA", False)
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Société en commandite".upper(), "SC")
        t.add_abridge("S.C.")
        t.add_variant("SCS", False)
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Societas Europaea".upper(), "SE")
        t.add_abridge("S.E.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Società in accomandita".upper(), "SAS")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Société en commandite par actions".upper(), "SCA")
        t.add_abridge("S.C.A.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Société en nom collectif".upper(), "SNC")
        t.add_variant("Società in nome collettivo".upper(), False)
        t.add_abridge("S.N.C.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("General Partnership".upper(), "GP")
        t.add_variant("General Partners", False)
        t.add_abridge("G.P.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Limited Partnership".upper(), "LP")
        t.add_abridge("L.P.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Kommanditaktiengesellschaft".upper(), "KGAA")
        t.add_variant("KOMMAG", False)
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Societe a Responsidilite Limitee".upper(), "SRL")
        t.add_abridge("S.A.R.L.")
        t.add_abridge("S.R.L.")
        t.add_variant("SARL", False)
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Società a garanzia limitata".upper(), "SAGL")
        t.add_abridge("S.A.G.L.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Società limitata".upper(), "SL")
        t.add_abridge("S.L.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Vennootschap Met Beperkte Aansparkelij kheid".upper(), "BV")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Vennootschap Met Beperkte Aansparkelij".upper(), "AVV")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Naamlose Vennootschap".upper(), "NV")
        t.add_abridge("N.V.")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Gesellschaft mit beschrakter Haftung".upper(), "GMBH")
        t.add_variant("ГМБХ", False)
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Aktiengesellschaft".upper(), "AG")
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("International Company".upper(), "IC")
        t.add_abridge("I.C.")
        OrgItemEngItem.__m_ontology.add(t)
        ...
        t.add_variant("& Company", False)
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Kollektivgesellschaft".upper(), "KG")
        t.add_abridge("K.G.")
        t.add_variant("OHG", False)
        OrgItemEngItem.__m_ontology.add(t)
        t = Termin._new1113("Kommanditgesellschaft".upper(), "KG")
