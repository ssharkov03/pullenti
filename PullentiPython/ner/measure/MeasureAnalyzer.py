...
from PullentiPython.ner.measure.internal.UnitMeta import UnitMeta
from PullentiPython.ner.measure.internal.MeasureMeta import MeasureMeta
            ...
            for r in kit.ontology.items: 
                ...
                for s in uu.slots: 
                    if (s.type_name == UnitReferent.ATTR_NAME or s.type_name == UnitReferent.ATTR_FULLNAME): 
                        addunits.add(Termin._new264(Utils.asObjectOrNull(s.value, str), uu))
        t = kit.first_token
        first_pass2927 = True
        while True:
