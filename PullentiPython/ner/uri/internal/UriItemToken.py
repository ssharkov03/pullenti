...
class UriItemToken(MetaToken):
    ...
    def attachisocontent(t0 : 'Token', spec_chars : str) -> 'UriItemToken':
        ...
        if (txt.tell() == 0): 
            return None
        return UriItemToken._new2467(t0, t1, Utils.toStringStringIO(txt))
    ...
    def __attach_uri_content(t0 : 'Token', chars_ : str, can_be_whitespaces : bool=False) -> 'UriItemToken':
        ...
        if (Utils.compareStrings(tmp, "WWW", True) == 0): 
            return None
        res = UriItemToken._new2467(t0, t1, Utils.toStringStringIO(txt))
        return res
            ...
            if (not str.isalpha(ch)): 
                ...
                if (ch == '-'): 
                    if (Utils.compareStrings(Utils.toStringStringIO(txt), "vk.com", True) == 0): 
                        return UriItemToken._new2467(t0, t1, Utils.toStringStringIO(txt).lower())
            else: 
                is_ip = False
    ...
    def attach_mail_users(t1 : 'Token') -> typing.List['UriItemToken']:
        ...
        if (txt.tell() == 0): 
            return None
        res = list()
        res.append(UriItemToken._new2467(t0, t1, Utils.toStringStringIO(txt).lower()))
        return res
    ...
    @staticmethod
    def _new2467(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str) -> 'UriItemToken':
