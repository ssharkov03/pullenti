...
class MorphCollection(MorphBaseInfo):
    ...
    def __init__(self, source : 'MorphCollection'=None) -> None:
        ...
        self.__m_class = MorphClass._new212(source.__m_class.value)
        self.__m_gender = source.__m_gender
        self.__m_case = MorphCase._new188(source.__m_case.value)
        self.__m_number = source.__m_number
        self.__m_language = MorphLang._new215(source.__m_language.value)
    ...
    def clone(self) -> 'MorphCollection':
        ...
        if (not self.__m_need_recalc): 
            res.__m_class = MorphClass._new212(self.__m_class.value)
            res.__m_gender = self.__m_gender
            res.__m_case = MorphCase._new188(self.__m_case.value)
            res.__m_number = self.__m_number
            res.__m_language = MorphLang._new215(self.__m_language.value)
    ...
    def _serialize(self, stream : Stream) -> None:
        from PullentiPython.ner.core.internal.SerializerHelper import SerializerHelper
    ...
    def _deserialize(self, stream : Stream) -> None:
        from PullentiPython.ner.core.internal.SerializerHelper import SerializerHelper
        self.__m_class = MorphClass._new212(SerializerHelper.deserialize_short(stream))
        self.__m_case = MorphCase._new188(SerializerHelper.deserialize_short(stream))
        ...
        self.__m_language = MorphLang._new215(SerializerHelper.deserialize_short(stream))
    ...
    def __deserialize_item(self, stream : Stream) -> 'MorphBaseInfo':
        ...
        res.class0_ = MorphClass._new212(SerializerHelper.deserialize_short(stream))
        res.case_ = MorphCase._new188(SerializerHelper.deserialize_short(stream))
        ...
        res.language = MorphLang._new215(SerializerHelper.deserialize_short(stream))
        if (ty == 0): 
            return res
    ...
    @staticmethod
    def _new700(_arg1 : 'MorphClass') -> 'MorphCollection':
        res = MorphCollection()
        res.class0_ = _arg1
        return res
    
    @staticmethod
    def _new2117(_arg1 : 'MorphGender') -> 'MorphCollection':
        res = MorphCollection()
        res.gender = _arg1
        return res
    
    @staticmethod
    def _new2166(_arg1 : 'MorphCase') -> 'MorphCollection':
        res = MorphCollection()
        res.case_ = _arg1
        return res
