...
from PullentiPython.ner.weapon.internal.WeaponItemToken import WeaponItemToken
...
from PullentiPython.ner.weapon.WeaponReferent import WeaponReferent
from PullentiPython.ner.weapon.internal.MetaWeapon import MetaWeapon
                        ...
                        if (s.type_name == WeaponReferent.ATTR_MODEL): 
                            ...
                            for k in range(2):
                                if (not str.isdigit(mod[0])): 
                                    ...
                                    inoutres2581 = Utils.tryGetValue(objs_by_model, mod, wrapli2580)
                                    li = wrapli2580.value
                                    if (not inoutres2581): 
                                        li = list()
