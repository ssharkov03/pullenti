...
from PullentiPython.semantic.utils.QuestionType import QuestionType
...
class ControlModelQuestion:
    ...
    def initialize() -> None:
        ...
        ControlModelQuestion.ITEMS.insert(ControlModelQuestion.__m_base_nominative_ind, ControlModelQuestion._new2661(None, MorphCase.NOMINATIVE, True))
        ControlModelQuestion.__m_base_genetive_ind = 1
        ControlModelQuestion.ITEMS.insert(ControlModelQuestion.__m_base_genetive_ind, ControlModelQuestion._new2661(None, MorphCase.GENITIVE, True))
        ControlModelQuestion.__m_base_accusative_ind = 2
        ControlModelQuestion.ITEMS.insert(ControlModelQuestion.__m_base_accusative_ind, ControlModelQuestion._new2661(None, MorphCase.ACCUSATIVE, True))
        ControlModelQuestion.__m_base_instrumental_ind = 3
        ControlModelQuestion.ITEMS.insert(ControlModelQuestion.__m_base_instrumental_ind, ControlModelQuestion._new2661(None, MorphCase.INSTRUMENTAL, True))
        ControlModelQuestion.__m_base_dative_ind = 4
        ControlModelQuestion.ITEMS.insert(ControlModelQuestion.__m_base_dative_ind, ControlModelQuestion._new2661(None, MorphCase.DATIVE, True))
        ...
        ControlModelQuestion.ITEMS.insert(6, ControlModelQuestion._new2666(None, None, QuestionType.WHERE, True))
        ControlModelQuestion.ITEMS.insert(7, ControlModelQuestion._new2666(None, None, QuestionType.WHERETO, True))
        ControlModelQuestion.ITEMS.insert(8, ControlModelQuestion._new2666(None, None, QuestionType.WHEREFROM, True))
        ControlModelQuestion.ITEMS.insert(9, ControlModelQuestion._new2666(None, None, QuestionType.WHEN, True))
    ...
    def find_by_spel(spel : str) -> 'ControlModelQuestion':
        ind = 0
        wrapind2670 = RefOutArgWrapper(0)
        inoutres2671 = Utils.tryGetValue(ControlModelQuestion.__m_hash_by_spel, spel, wrapind2670)
        ind = wrapind2670.value
        if (not inoutres2671): 
            return None
        return ControlModelQuestion.ITEMS[ind]
    
    @staticmethod
    def _new2661(_arg1 : str, _arg2 : 'MorphCase', _arg3 : bool) -> 'ControlModelQuestion':
        res = ControlModelQuestion(_arg1, _arg2)
        res.is_base = _arg3
        return res
    
    @staticmethod
    def _new2666(_arg1 : str, _arg2 : 'MorphCase', _arg3 : 'QuestionType', _arg4 : bool) -> 'ControlModelQuestion':
