...
from PullentiPython.semantic.utils.ExplanWordAttr import ExplanWordAttr
...
class DerivateWord:
    ...
    @staticmethod
    def _new2673(_arg1 : str, _arg2 : 'MorphLang', _arg3 : 'MorphClass', _arg4 : 'MorphAspect', _arg5 : bool, _arg6 : 'MorphTense', _arg7 : 'MorphVoice', _arg8 : 'ExplanWordAttr') -> 'DerivateWord':
        res = DerivateWord()
        res.spelling = _arg1
        res.lang = _arg2
        res.class0_ = _arg3
