...
from PullentiPython.semantic.utils.ControlModel import ControlModel
from PullentiPython.morph.MorphLang import MorphLang
from PullentiPython.semantic.utils.DerivateWord import DerivateWord
...
class DerivateGroup:
    ...
    def create_by_prefix(self, pref : str, lang : 'MorphLang') -> 'DerivateGroup':
        res = DerivateGroup._new2672(True, pref)
        for w in self.words: 
            if (lang is not None and not lang.is_undefined and ((w.lang) & lang).is_undefined): 
                continue
            rw = DerivateWord._new2673(pref + w.spelling, w.lang, w.class0_, w.aspect, w.reflexive, w.tense, w.voice, w.attrs)
            res.words.append(rw)
        return res
    ...
    @staticmethod
    def _new2672(_arg1 : bool, _arg2 : str) -> 'DerivateGroup':
        res = DerivateGroup()
