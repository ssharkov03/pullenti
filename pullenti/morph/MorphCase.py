...
class MorphCase:
    ...
    def __and__(self : 'MorphCase', arg2 : 'MorphCase') -> 'MorphCase':
        ...
        if (arg2 is not None): 
            val2 = arg2.value
        return MorphCase._new188(((val1) & (val2)))
    ...
    @staticmethod
    def _new188(_arg1 : int) -> 'MorphCase':
        res = MorphCase()
        res.value = _arg1
        return res
    ...
    @staticmethod
    def _static_ctor():
        MorphCase.UNDEFINED = MorphCase._new188(0)
        MorphCase.NOMINATIVE = MorphCase._new188(1)
        MorphCase.GENITIVE = MorphCase._new188(2)
        MorphCase.DATIVE = MorphCase._new188(4)
        MorphCase.ACCUSATIVE = MorphCase._new188(8)
        MorphCase.INSTRUMENTAL = MorphCase._new188(0x10)
        MorphCase.PREPOSITIONAL = MorphCase._new188(0x20)
        MorphCase.VOCATIVE = MorphCase._new188(0x40)
        MorphCase.PARTIAL = MorphCase._new188(0x80)
        MorphCase.COMMON = MorphCase._new188(0x100)
        MorphCase.POSSESSIVE = MorphCase._new188(0x200)
        MorphCase.ALL_CASES = MorphCase._new188(0x3FF)
