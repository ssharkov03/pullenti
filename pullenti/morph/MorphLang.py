...
class MorphLang:
    ...
    def __and__(self : 'MorphLang', arg2 : 'MorphLang') -> 'MorphLang':
        ...
        if (arg2 is not None): 
            val2 = arg2.value
        return MorphLang._new215(((val1) & (val2)))
    ...
    @staticmethod
    def _new215(_arg1 : int) -> 'MorphLang':
        res = MorphLang()
        res.value = _arg1
        return res
    
    @staticmethod
    def _new217(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_ru = _arg1
        return res
    
    @staticmethod
    def _new218(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_ua = _arg1
        return res
    
    @staticmethod
    def _new219(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_by = _arg1
        return res
    
    @staticmethod
    def _new220(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_en = _arg1
        return res
    
    @staticmethod
    def _new221(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_it = _arg1
        return res
    
    @staticmethod
    def _new222(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_kz = _arg1
        return res
    ...
    def _static_ctor():
        ...
        MorphLang.RU = MorphLang._new217(True)
        MorphLang.UA = MorphLang._new218(True)
        MorphLang.BY = MorphLang._new219(True)
        MorphLang.EN = MorphLang._new220(True)
        MorphLang.IT = MorphLang._new221(True)
        MorphLang.KZ = MorphLang._new222(True)
