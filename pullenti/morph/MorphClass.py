...
class MorphClass:
    ...
    def __and__(self : 'MorphClass', arg2 : 'MorphClass') -> 'MorphClass':
        ...
        if (arg2 is not None): 
            val2 = arg2.value
        return MorphClass._new212(((val1) & (val2)))
    ...
    @staticmethod
    def _new203(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_undefined = _arg1
        return res
    
    @staticmethod
    def _new204(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_noun = _arg1
        return res
    
    @staticmethod
    def _new205(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_pronoun = _arg1
        return res
    
    @staticmethod
    def _new206(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_personal_pronoun = _arg1
        return res
    
    @staticmethod
    def _new207(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_verb = _arg1
        return res
    
    @staticmethod
    def _new208(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_adjective = _arg1
        return res
    
    @staticmethod
    def _new209(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_adverb = _arg1
        return res
    
    @staticmethod
    def _new210(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_preposition = _arg1
        return res
    
    @staticmethod
    def _new211(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_conjunction = _arg1
        return res
    
    @staticmethod
    def _new212(_arg1 : int) -> 'MorphClass':
        res = MorphClass()
        res.value = _arg1
        return res
    
    @staticmethod
    def _new2344(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
    ...
    def _static_ctor():
        ...
        MorphClass.UNDEFINED = MorphClass._new203(True)
        MorphClass.NOUN = MorphClass._new204(True)
        MorphClass.PRONOUN = MorphClass._new205(True)
        MorphClass.PERSONAL_PRONOUN = MorphClass._new206(True)
        MorphClass.VERB = MorphClass._new207(True)
        MorphClass.ADJECTIVE = MorphClass._new208(True)
        MorphClass.ADVERB = MorphClass._new209(True)
        MorphClass.PREPOSITION = MorphClass._new210(True)
        MorphClass.CONJUNCTION = MorphClass._new211(True)
